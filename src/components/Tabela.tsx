    ...
    function renderizarCabecalho() {
        return (
            <tr>
                ...
                <th className="text-left p-4">Seção</th>
        ...
        return props.clientes?.map((cliente, i) => {
            return (
                <tr key={cliente.id}
                    ...
                    <td className="text-left p-4 w-1/6">{cliente.id}</td>
                    <td className="text-left p-4">{cliente.nome}</td>
                    <td className="text-left p-4">{cliente.idade}</td>
                    <td className="text-left p-4">{cliente.email}</td>
                    <td className="text-left p-4">{cliente.empresa}</td>
                    <td className="text-left p-4">{cliente.secao}</td>
